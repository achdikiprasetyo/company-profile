...
<body class="page-loaded">
    ...
    <div class="contact-container">
        ...
        <ul class="social-icons">
            ...
            <li><a href="your-instagram-url" target="_blank"><i class="fab fa-instagram"></i></a></li>
            <li><a href="mailto:your-email" target="_blank"><i class="far fa-envelope"></i></a></li>
            <li><a href="your-facebook-url" target="_blank"><i class="fab fa-facebook"></i></a></li>
            <li><a href="your-whatsapp-url" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
            <li><a href="your-tiktok-url" target="_blank"><i class="fab fa-tiktok"></i></a></li>
        </ul>
